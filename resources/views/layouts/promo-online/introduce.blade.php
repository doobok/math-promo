<div id="{{$id}}" class="relative flex flex-col-reverse py-16 lg:py-0 lg:flex-col">
      ...
      <div class="flex flex-col items-center">
        ...
        <div class="flex items-center space-x-4">
          <div class="flex items-center">
            <a href="/" class="text-gray-600 transition-colors duration-300 hover:text-primary-400">
  ...
  <div class="inset-y-0 top-0 right-0 w-full max-w-xl px-4 mx-auto mb-6 md:px-0 lg:pl-8 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-1/2 lg:max-w-full lg:absolute xl:px-0">
    {{-- <img
      ...
      alt=""
    /> --}}
    <iframe class="object-cover w-full h-56 rounded shadow-lg lg:rounded-none lg:shadow-none md:h-96 lg:h-full " src="https://www.youtube.com/embed/anu1By13Dso?controls=0&color=white" title="Tutor-Math Online" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>
</div>
