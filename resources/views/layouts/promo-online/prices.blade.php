        ...
        <div class="w-full md:w-1/2 lg:w-1/3 px-5">
          <div class="p-8 bg-gray-200 rounded">
            <div class="mb-4 text-center">
              <p class="text-xl font-medium tracking-wide text-gray-700">
                Starter Plan
              </p>
            ...
            <ul class="mb-8 space-y-2">
              <li class="flex items-center">
                ...
                <p class="font-medium text-gray-500">10 deploys per day</p>
              </li>
              <li class="flex items-center">
                <div class="mr-3">
                  <svg class="w-4 h-4 text-green-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
                ...
                <p class="font-medium text-gray-500">10 GB of storage</p>
              </li>
              <li class="flex items-center">
                <div class="mr-3">
                  <svg class="w-4 h-4 text-green-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
                ...
                <p class="font-medium text-gray-500">3 domains</p>
              </li>
              <li class="flex items-center">
                <div class="mr-3">
                  <svg class="w-4 h-4 text-green-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
                ...
                <p class="font-medium text-gray-500">SSL Certificates</p>
              </li>
            </ul>
            <button
              type="submit"
