<div id="{{$id}}" class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
  <div class="flex flex-col mb-6 lg:flex-row md:mb-10">
    <div class="lg:w-1/2">
      <h2 class="max-w-md mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none xl:max-w-lg">
          {{__('extensions.title-1')}}
        <span class="text-primary-500">{{__('extensions.title-2')}}</span>
      </h2>
    </div>
    <div class="lg:w-1/2">
      <p class="text-base text-gray-700 md:text-lg">
          {!! __('extensions.description') !!}
      </p>
    </div>
  </div>
  <div class="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <div class="max-w-md grid grid-cols-1 justify-items-center place-content-start">
      ...
      <h6 class="mb-2 font-semibold leading-5">{{__('extensions.element-1-t')}}</h6>
      <div>
        <p class="mb-3 font-semibold text-sm text-primary-500">
          <span class="border-l-4 border-primary-400 pl-2">
              {{__('extensions.element-1-s')}}
          </span>
        </p>
        <p class="mb-3 text-sm text-gray-900">
            {{__('extensions.element-1-d')}}
        </p>
      </div>
    </div>
    ...
    <div class="max-w-md grid grid-cols-1 justify-items-center place-content-start">
      ...
      <h6 class="mb-2 font-semibold leading-5">{{__('extensions.element-2-t')}}</h6>
      <div>
        <p class="mb-3 font-semibold text-sm text-primary-500">
          <span class="border-l-4 border-primary-400 pl-2">
              {{__('extensions.element-2-s')}}
          </span>
        </p>
        <p class="mb-3 text-sm text-gray-900">
            {{__('extensions.element-2-d')}}
        </p>
      </div>
    </div>
    <div class="max-w-md grid grid-cols-1 justify-items-center place-content-start">
      ...
      <h6 class="mb-2 font-semibold leading-5">{{__('extensions.element-3-t')}}</h6>
      <div>
        <p class="mb-3 font-semibold text-sm text-primary-500">
          <span class="border-l-4 border-primary-400 pl-2">
              {{__('extensions.element-3-s')}}
          </span>
        </p>
        <p class="mb-3 text-sm text-gray-900">
            {{__('extensions.element-3-d')}}
        </p>
      </div>
    </div>
    <div class="max-w-md grid grid-cols-1 justify-items-center place-content-start">
      ...
      <h6 class="mb-2 font-semibold leading-5">{{__('extensions.element-4-t')}}</h6>
      <div>
        <p class="mb-3 font-semibold text-sm text-primary-500">
          <span class="border-l-4 border-primary-400 pl-2">
              {{__('extensions.element-4-s')}}
          </span>
        </p>
        <p class="mb-3 text-sm text-gray-900">
            {{__('extensions.element-4-d')}}
        </p>
      </div>
    </div>
  </div>
  <div class="flex justify-center mt-12">
    ...
    <smpl-button txt="{{__('extensions.button')}}" cls="h-12" clr="secondary" slug="{{$slug}}"></smpl-button>
